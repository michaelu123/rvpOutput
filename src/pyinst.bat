...
pyinstaller -y -n rvpOutput -F -p  ..\lib\site-packages adfc_gui.py myLogger.py printHandler.py textHandler.py rawHandler.py docxHandler.py tourRest.py tourServer.py event.py eventXml.py
